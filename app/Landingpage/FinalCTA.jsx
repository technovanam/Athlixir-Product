    ...
    return (
        <section className="relative h-[500px] md:h-[650px] flex items-center justify-center overflow-hidden bg-black">
            ...
            <div className="relative z-20 text-center text-white px-6 md:px-12 container mx-auto flex flex-col items-center">
                ...
                <p className="text-base md:text-lg mb-12 max-w-2xl mx-auto font-light leading-relaxed text-gray-400">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center space-y-5 sm:space-y-0 sm:space-x-8">
                    <Link
                        href="/signup"
                        className="px-8 py-3.5 bg-primary text-white font-bold rounded-full hover:bg-orange-600 transition-all shadow-[0_0_30px_rgba(255,87,34,0.4)] text-xs uppercase tracking-widest hover:scale-105 min-w-[180px] flex items-center justify-center"
                    >
                        Create Free Profile
                    </Link>
                    <Link
                        href="/login"
                        className="px-8 py-3.5 bg-white/5 backdrop-blur-md border border-white/20 text-white font-bold rounded-full hover:bg-white hover:text-black transition-all text-xs uppercase tracking-widest min-w-[180px] hover:scale-105 flex items-center justify-center"
                    >
                        Explore Platform
                    </Link>
                </div>
